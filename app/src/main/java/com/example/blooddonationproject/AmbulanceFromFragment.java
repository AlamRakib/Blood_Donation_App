...
public class AmbulanceFromFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView =  inflater.inflate(R.layout.fragment_ambulance_from, container, false);


        editText1 = myView.findViewById(R.id.OwnerNameID);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String url = "https://rakibalam.000webhostapp.com/apps/BloodDonationProject/AmbulanceInsert.php?n=" +edOwnerName+ "&d=" +edDistrict+ "&c=" +edNumber;
