...
public class OrganizationFragment extends Fragment {
   ...
   Button searchBtn;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView =  inflater.inflate(R.layout.fragment_organization, container, false);


        //districteditText = myView.findViewById(R.id.districtNameId);
        listView = myView.findViewById(R.id.listViewId);
        progressBar = myView.findViewById(R.id.progressBarId);
        //searchBtn = myView.findViewById(R.id.searchButtonId);
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Fragment fragment = new OrganaizationFromFragment();
    ...
    public void loadData()
    {
        ...
        String url = "https://rakibalam.000webhostapp.com/apps/BloodDonationProject/ORGview.php";
